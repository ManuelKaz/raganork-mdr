...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'Manuelk;bot;265994277623;https://i.ibb.co/3cpVdRb/Manuel.jpg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA,
    BOT_NAME: process.env.BOT_NAME || 'Manuel',
    ...
    SUDO: process.env.SUDO || '265994277623,0',
